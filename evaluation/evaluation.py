'''
Supported by OpenAI, github repo: https://github.com/openai/guided-diffusion/tree/main/evaluations

this script is used to evaluate the quality of the generated images by the model, 
including Inception Score(IS), FID, sFID, Precision, and Recall.

run the script through the shell script: evaluation/evaluation.sh.
'''
